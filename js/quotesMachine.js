var quotes = {
    ...
    arrPolity: [
        ...
        "In the end the Party would announce that two and two made five, and you would have to believe it\t@&#12298;1984&#12299;乔治.奥威尔\t",
        "Artists use lies to tell the truth, while politicians use them to cover the truth up.\t@&#12298;V for Vendetta&#12299;\t",
        "世上最难的两件事: 把自己的思想装进别人的脑袋, 把别人的钞票装进自己的口袋 -- 他们都做到了",
    ...
    arrProgram: [
        ...
        "软件就像'性' -- 免费自由的时候更好 :-)\tSoftware is like sex; it's better when it's free.\t@Linus Torvalds (Linux 之父)"
    ],
    arrThink: [
        "兴趣是最好的老师\t@爱因斯坦\t",
...
var arrMaxim = quotes.arrDefault.slice(), nCount = 0;
...
$.each(arrTagInfo, function(index, info) { sLabels.match(info[0]) && (arrMaxim = arrMaxim.concat(info[1])) && nCount++});
...
$("#quotes").animate({
   ...
   function () {
     ...
     if (quoteArr[1]) {author = quoteArr[1]}
