var quotes = {
	arrDefault: [
		...
		'那不能杀死我的, 使我更强!\tWhat does not kill me, makes me stronger.\t@尼采\t',
	...
	arrHistory: [
		'Who controls the past controls the future; who controls the present controls the past.\t@&#12298;1984&#12299;乔治.奥威尔\t',
	...
	arrPolity: [
		...
		'Government is not the solution to our problem, government IS the problem.\t@里根 (美国前总统)',
		...
		'It is the duty of every patriot to protect his country from its government\t@托马斯.潘恩 (政治思想家)',
		'The spirit of resistance to government is so valuable on certain occasions, \tthat I wish it to be always kept alive.\t@Thomas Jefferson (美国前总统 独立宣言起草人)',
		'When the people fear the government, there is tyranny.\tWhen governments fear the people, there is liberty.\t@Thomas Jefferson (美国前总统 独立宣言起草人)',
		'When injustice becomes law, resistance becomes duty.',
		'Those who give up essential liberty to purchase a little temporary safety, deserve neither liberty nor safety.\t@本杰明.富兰克林 (美国开国元勋 物理学家 作家)',
		'现在有人对你们说: \'牺牲你们个人的自由, 去求国家的自由!\'\t我要对你们说: \'争取个人的自由, 就是争取国家的自由; 争取个人的人格, 就是争取国家的国格&#12290;自由平等的国家不是一群奴才建造得起来的!\'\t@胡适 (思想家)\t',
		'美国人来了, 有面包有自由; \t苏俄来了, 有面包无自由; \t他们来了, 无面包无自由!\t@胡适 (思想家)\t',
		'Laws alone can not secure freedom of expression;\tin order that every man present his views without penalty there must be spirit of tolerance in the entire population.\t@爱因斯坦',
		'解放一个习惯于被奴役的民族比奴役一个习惯于自由的民族更难\t@孟德斯鸠 (启蒙思想家)\t',
		'将愚人从他们所敬拜的锁链下解放出来是非常困难的\t@伏尔泰 (启蒙思想家)\t',
		'The attempt to make heaven on earth invariably produces hell.\t@波普尔 (哲学家 思想家)',
		...
		'How do you tell a communist? Well, it\'s someone who reads Marx and Lenin. And how do you tell an anti-Communist? It\'s someone who understands Marx and Lenin.&#12290;\t@Ronald Reagan (美国前总统)',
		'Communism doesn\'t work because people like to own stuff.\t@Frank Zappa (音乐家)',
		...
		'父母在教育孩子时, 通常只是让他们适应当前的世界 -- 哪怕当前是个堕落的世界&#12290;\t@康德',
    ...
    '我不同意你的观点	但是我誓死捍卫你说话的权利\t@伏尔泰 (启蒙思想家)',
		...
		'你可以暂时地蒙骗所有人, 也可以永久地蒙骗部分人; \t但你不可能永久地蒙骗所有人!\tYou can fool all the people some of the time, some of the people all the time, but you cannot fool all the people all the time.\t@林肯 (美国前总统)',
		'All in all you\'re just another brick in the wall!\t@&#12298;The Wall&#12299;Pink Floyd',
		'在大欺骗的时代, 说出真相就是革命行为!\t@乔治.奥威尔 (&#12298;1984&#12299;作家)',
		...
		'To be a scientist is to be naive. We are so focused on our search for truth, we fail to consider how few actually want us to find it. But it is always there, whether we see it or not, whether we choose to or not. The truth doesn’t care about our needs or wants. It doesn’t care about our governments, our ideologies, our religions. It will lie in wait, for all time. And this, at last, is the gift of Chernobyl. Where I once would fear the cost of truth, now I only ask: What is the cost of lies?\t@&#12298;Chernobyl&#12299;',
    ...
    '当你试图了解你的祖国, 你已经走上了犯罪道路!	@艾未未 (艺术家 持不同政见者)',
		...
		'信仰不能当饭吃, 所以不重要; 民主不能当饭吃, 所以不重要; 自由不能当饭吃, 所以不重要...\t对我们来说, 不能当饭吃的, 都不重要!\t我们信奉了猪的生活原则, 也就得到了猪的命运 -- 迟早给别人当饭吃',
		'如果国家的民众以猪的方式思考\t那么国家的统治者就会以屠夫的方式行事',
		'与恶魔战斗的勇士, 要小心自己也变成恶魔&#12290;	当你长久凝视深渊, 深渊也在凝视着你&#12290;	@尼采 (哲学家)',
		'每当有事情发生, 懦夫会问: \'这么做安全吗?\'\t患得患失者会问: \'这么做明智吗?\'\t虚荣者会问: \'这么做受欢迎吗?\'\t但是良知只会问: \'这么做正确吗?\'\t@马丁.路德.金 (美国人权领袖)',
		'人道主义的含义是 -- 从不以[人]作为牺牲来达到某一目的\t@施韦策 (诺贝尔和平奖得主)',
		'Unlimited tolerance must lead to the disappearance of tolerance.\t@波普尔 (哲学家 思想家)',
		'雪崩时, 没有一片雪花觉得自己有责任\t@伏尔泰 (启蒙思想家)',
		'战争是流血的政治	政治是不流血的战争	@&#12298;战争论&#12299;克劳塞维茨',
		'…there\'s no question of heroism in all this. It\'s a matter of common decency. That\'s an idea which may make some people smile, but the only means of fighting a plague is - common decency.\t与鼠疫斗争的唯一方式只能是诚实@Albert Camus(哲学家 作家)',
	],
	arrProgram: [
		'In the information age, the barriers [to entry into programming] just aren\'t there.\tThe barriers are self imposed.\tIf you want to set off and go develop some grand new thing, you don\'t need millions of dollars of capitalization.\tYou need enough pizza and Diet Coke to stick in your refrigerator, a cheap PC to work on, and the dedication to go through with it.\t@John D. Carmack(Hacker, Game Programmer)',
		...
		'软件就像\'性\' -- 自由的时候更好 :-)\tSoftware is like sex; it\'s better when it\'s free.\t@Linus Torvalds (Linux 之父)',
	],
	arrThink: [
		'兴趣是最好的老师\t@爱因斯坦\t',
		'So many books, so little time.\t@Frank Zappa(Musician)',
		...
		'All life is problem solving\t@波普尔 (哲学家 思想家)',
	...
	arrOthers: ['唯一不变的是变化本身!'],
};

var sLabels = 'think psychology gfw politics history programming management economy';

var arrTagInfo = [
	[/think|psychology/, quotes.arrThink],
	[/gfw/, quotes.arrGFW],
	[/politics/, quotes.arrPolity],
	[/history/, quotes.arrHistory],
	[/programming/, quotes.arrProgram],
	[/economy/, quotes.arrEconomy],
];

var arrMaxim = quotes.arrDefault.slice(),
	nCount = 0;

var arrPunctMap =
	// map HALF width punct to FULL width
	[
		[/\t/g, '<br/>'],
		[/@/g, '&#8212;&#8212;'],
		[/ -- /g, '&#8212;&#8212;'],
...
$.each(arrTagInfo, function(index, info) {
	sLabels.match(info[0]) && (arrMaxim = arrMaxim.concat(info[1])) && nCount++;
});
nCount <= 3 && (arrMaxim = arrMaxim.concat(quotes.arrOthers));
...
function assert(condition, sDesc) {
	if (!condition) {
...
String.prototype.multiReplace = function(arrSyntax) {
	assert(Array.isArray(arrSyntax), 'String.multiReplace: Invalid \'arrSyntax\'!');
	var sRtn = this;
	$.each(arrSyntax, function(i, syntax) {
		sRtn = sRtn.replace(syntax[0], syntax[1]);
	});
	return sRtn;
};
...
function getQuote() {
	$('#quotes').animate(
		...
		400,
		function() {
			sMaxim = arrMaxim[Math.floor(Math.random() * arrMaxim.length)];
			quoteArr = sMaxim.split('@');
			quote = quoteArr[0].multiReplace(arrPunctMap);
			if (quoteArr[1]) {
				author = quoteArr[1];
			} else {
				author = 'Anonymous';
...
// quote Machine is inspired by Programthink:https://program-think.blogspot.com
